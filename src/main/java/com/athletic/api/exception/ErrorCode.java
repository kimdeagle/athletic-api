...
public enum ErrorCode {
    ...
    OVERFLOW_MAX_ROWS_EXCEL_DOWNLOAD(914, ErrorMessage.ExcelDownload.OVERFLOW_MAX_ROWS),
    EMPTY_EXCEL_UPLOAD_FILE(915, ErrorMessage.ExcelUpload.EMPTY_FILE),
    EMPTY_EXCEL_UPLOAD_ROW(916, ErrorMessage.ExcelUpload.EMPTY_ROW),
    INVALID_EXCEL_UPLOAD_FILE(917, ErrorMessage.ExcelUpload.INVALID_FILE),
    ERROR_EXCEL_UPLOAD_BY_TEMPLATE(918, ErrorMessage.ExcelUpload.MESSAGE_TEMPLATE),
    DUPLICATION_MEMBER_IN_EXCEL(919, ErrorMessage.ExcelUpload.DUPLICATION_MEMBER_IN_EXCEL),
    EXIST_MEMBER_IN_DATABASE(920, ErrorMessage.ExcelUpload.EXIST_MEMBER_IN_DATABASE),
    FAIL_EXCEL_UPLOAD(921, ErrorMessage.ExcelUpload.FAIL),
    FAIL_SEND_EMAIL(922, ErrorMessage.Email.FAIL),
