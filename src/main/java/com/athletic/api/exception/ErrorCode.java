...
public enum ErrorCode {
    ...
    INVALID_EXCEL_UPLOAD_FILE(916, ErrorMessage.ExcelUpload.INVALID_FILE),
    ERROR_EXCEL_UPLOAD_BY_TEMPLATE(917, ErrorMessage.ExcelUpload.MESSAGE_TEMPLATE),
    DUPLICATION_MEMBER_IN_EXCEL(918, ErrorMessage.ExcelUpload.DUPLICATION_MEMBER_IN_EXCEL),
    EXIST_MEMBER_IN_DATABASE(919, ErrorMessage.ExcelUpload.EXIST_MEMBER_IN_DATABASE),
    FAIL_EXCEL_UPLOAD(920, ErrorMessage.ExcelUpload.FAIL),
    FAIL_SEND_EMAIL(921, ErrorMessage.Email.FAIL),
